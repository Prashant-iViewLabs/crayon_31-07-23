  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        <Grid marginLeft={1} marginRight={1} sx={{
          ...
          >
            ...
            <Box
              sx={
                job?.candidate_profile?.industry_users.length <= 2
                  ? {
                    width: "100%",
                    display: "flex",
                  }
      ...
      >
        ...
        {job?.candidate_profile?.candidate_info?.primary?.name !== undefined &&
          <Box
            component="img"
            height={90}
            ...
            alt="Personality"
            src={
              (job?.candidate_profile?.candidate_info?.primary?.name === "collaborator" && profile_collaborator) ||
              (job?.candidate_profile?.candidate_info?.primary?.name === "challenger" && profile_challenger) ||
              (job?.candidate_profile?.candidate_info?.primary?.name === "character" && profile_character) ||
              (job?.candidate_profile?.candidate_info?.primary?.name === "contemplator" && profile_contemplator)
            }
          />
        }
        {job?.candidate_profile?.candidate_info?.shadow?.name !== undefined &&
          <Box
            ...
            alt="Personality"
            src={
              (job?.candidate_profile?.candidate_info?.shadow?.name === "collaborator" && profile_collaborator) ||
              (job?.candidate_profile?.candidate_info?.shadow?.name === "challenger" && profile_challenger) ||
              (job?.candidate_profile?.candidate_info?.shadow?.name === "character" && profile_character) ||
              (job?.candidate_profile?.candidate_info?.shadow?.name === "contemplator" && profile_contemplator)
            }
          />
        }
      </Grid>
